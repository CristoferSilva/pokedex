...
namespace Pokedex.PokedexViewModel
{
    public class PokemonViewModel : ObservableObject
    {
        ...
        private const int PokemonMaxLimit = 250;

        private const int AmountOfPokemonPerPage = 10;
        ...
        public string InsertPokemonFromUserType
        {
            ...
            set { SetProperty(ref _pokemonFromUserType, value.ToLower()); }
        }
        ...
        public string InsertPokemonFromUserAbilities
        {
            ...
            set { SetProperty(ref _pokemonFromUserAbilities, value.ToLower()); }
        }

        private void CreatePokemonFromUser()
        {
        ...
        public async Task LoadPictureNewPokemon()
        {
            ...
            if (file != null)
            {
                ...
                await file.CopyAsync(pathPicturesPokemons, $"{ID}.png");
        ...
        public string SearchPokemon
        {
            ...
            set { SetProperty(ref _searchPokemon, value.ToLower()); }
        }
        ...
        {
            if (CurrentPageView == 25 && areThereUserCreatedPokemons())
            {
                CurrentPageView++;
                PokemonCollection.Clear();
                ProgrssRingAndClickEnable();
        ...
        public async Task<List<Pokemon>> GetTenPokemonsByPaging(int page)
        {
            ...
            if (pokemonList.Count == AmountOfPokemonPerPage)
            {
                return pokemonList;
            }
            else if (page < 25)
            {
                ...
                int timesToRepeat = AmountOfPokemonPerPage;

                while (counter < timesToRepeat && lastPokemonID <= PokemonMaxLimit)
                {
                    lastPokemonID++;
                ...
                switch (IndexComboBox)
                {
                    ...
                    case 0:
                        ...
                        else
                        {
                            PokemonCollection.Clear();
                            ProgrssRingAndClickEnable();
                            await FindPokemonByNameAsync(SearchPokemon.Replace(" ", String.Empty));
                            ProgrssRingAndClickEnable();
                    ...
                    case 1:
                        PokemonCollection.Clear();
                        ProgrssRingAndClickEnable();
                        await FindPokemonByType(SearchPokemon.Replace(" ", String.Empty));
                        ProgrssRingAndClickEnable();
